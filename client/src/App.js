      ...
      <Router>
        <div className="App">
          <Switch>
            ...
            />
            <Route path={'/2-3Tree'} exact component={()=><Home initialTreeChoice={'23T'} 
                                                                order={3}  
            ...
            />
            <Route path={'/2-3-4Tree'} exact component={()=><Home initialTreeChoice={'234'} 
                                                                  order={4}  
            ...
            />
            <Route path={'/BinaryTree'} exact component={()=><Home initialTreeChoice={'BST'} 
                                                                   order={0}  
            ...
            />
            <Route path={'/AVLTree'} exact component={()=><Home initialTreeChoice={'AVL'} 
                                                                order={0}  
            ...
            />
            <Route path={'/BTree'} exact component={()=><Home initialTreeChoice={'B-T'} 
                                                              order={5} 
